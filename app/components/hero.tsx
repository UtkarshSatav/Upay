      ...
      <div className="mx-auto flex max-w-7xl flex-row items-stretch gap-12 min-h-screen">
        ...
        <div className="flex w-1/2 flex-col items-start justify-center gap-6 py-12">
          ...
          <header className="flex flex-wrap items-center gap-3 text-[72px] font-bold leading-[1.1] tracking-tight text-gray-900">
            ...
            <div className="inline-flex rotate-[8deg] items-center justify-center rounded-xl bg-gray-100 p-1.5 shadow-[0_0.4px_1.3px_-0.4px_rgba(8,203,0,0.09),0_1.6px_4.8px_-0.8px_rgba(8,203,0,0.12),0_7px_21px_-1.25px_rgba(8,203,0,0.24)]">
              <div className="rounded-lg bg-linear-to-br from-green-600 to-green-500 p-1.5">
                <svg
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-2 rounded-xl border-2 border-gray-100 bg-linear-to-br from-green-600 to-green-500 px-5 py-2.5 text-[15px] font-semibold text-white shadow-[0_0.4px_0.9px_-0.4px_rgba(8,203,0,0.13),0_1.6px_3.5px_-0.8px_rgba(8,203,0,0.17),0_7px_15.4px_-1.25px_rgba(8,203,0,0.36)] transition-all hover:scale-105"
            >
        ...
        <div className="relative flex w-1/2 flex-col items-center overflow-visible py-12">
          ...
          >
            ...
            <div className="relative h-full rounded-[32px] bg-white p-3 shadow-[0_20px_60px_rgba(0,0,0,0.3)]">
              <div className="relative h-full overflow-hidden rounded-[24px]">
                <img
                  src="/screenshot/home-dashboard.png"
